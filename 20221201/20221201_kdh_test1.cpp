// 20221201_kdh_test1.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
	...
	avg = sum / 10;
	printf("sum = %6.3lf l average = %6.3lf\n", sum, avg);
	...
	for (i = 0; i < 10; i++)
	{
		...
		{
			printf("입력된 숫자의 값이 랜덤 값 보다 작습니다. \n");
		}
